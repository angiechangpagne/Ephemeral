...
const Carousal = (props) => {
    ...
    //idea: make the backend data structure a graph for MVP
    ...
    const constructVisibleItemsProps = () => {
        ...
        let opacityDivider = (.7 / elementsInRight)
        ...
        while (timesToIterate < visibleImages) {
            ...
            if (timesToIterate < elementsInRight) {
                ...
                opacity = 1 - (opacityDivier * Math.abs(leftEltCount - (timesToIterate + 1)))

...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"assets/thumbnail.jpg":[function(require,module,exports) {
module.exports = "/thumbnail.b3baa9ff.jpg";
...
var thumbnail_jpg_1 = __importDefault(require("./assets/thumbnail.jpg"));
...
function App() {
  ...
  var styles = react_1.useMemo(function () {
    var activeRow = Math.ceil((active + 1) / c.ITEMS_PER_ROW); // Active item's index as row

    var activeColumn = active % c.ITEMS_PER_ROW; // Active item's index as column

    return items.map(function (_, i) {
      var currentRow = Math.ceil((i + 1) / c.ITEMS_PER_ROW);
      ...
      var scale = c.SLIDE_HOVER_WIDTH / c.SLIDE_WIDTH;
      var translate = (c.SLIDE_HOVER_WIDTH - c.SLIDE_WIDTH) / 2;
...
},{"sanitize.css":"../node_modules/sanitize.css/sanitize.css","./global.css":"global.css","react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./assets/thumbnail.jpg":"assets/thumbnail.jpg"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
